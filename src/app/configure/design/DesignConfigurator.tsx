    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          ...
          <div className="absolute z-40 inset-0 left-[3px] top-px right-[3px] bottom-px rounded-[32qpx] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]" />
          <div
            className={cn(
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          <Radio
                            ...
                            className={({ checked }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg bg-white px-6 py-4 showdow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",
                                {
