...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casecobra-ten-lemon.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your package has been shipped. Delivery usually takes two days!
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions regarding your order, feel free to
              contact us with your order number and we are here to help!
            </Text>
          </Section>
          <Hr style={global.hr} />
